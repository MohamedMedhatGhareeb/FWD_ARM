...
#define NVIC_PRIORITY_BASE            ((volatile uint8 *)(CORTEXM4_CORE_PERI_BASE + 0x400)) // Accessing it byte by byte
#define NVIC_IRQENABLE_BASE           ((volatile uint8 *)(CORTEXM4_CORE_PERI_BASE + 0x100)) // Accessing it byte by byte
